...
const UBICACIONES = [
  { community: 'Aragón', province: 'Huesca', councils: ['Huesca', 'Monzón', 'Barbastro', 'Jaca', 'Fraga'] },
  { community: 'Aragón', province: 'Zaragoza', councils: ['Zaragoza', 'Calatayud', 'Ejea de los Caballeros', 'Utebo', 'Tarazona'] },
  { community: 'Aragón', province: 'Teruel', councils: ['Teruel', 'Alcañiz', 'Andorra', 'Calamocha'] },
  { community: 'Cataluña', province: 'Barcelona', councils: ['Barcelona', 'Hospitalet', 'Badalona', 'Terrassa', 'Sabadell'] },
  { community: 'Cataluña', province: 'Tarragona', councils: ['Tarragona', 'Reus', 'Tortosa', 'Salou'] },
  { community: 'Cataluña', province: 'Girona', councils: ['Girona', 'Figueres', 'Blanes', 'Lloret de Mar'] },
  { community: 'Comunidad de Madrid', province: 'Madrid', councils: ['Madrid', 'Alcalá de Henares', 'Móstoles', 'Getafe', 'Leganés'] },
  { community: 'Andalucía', province: 'Sevilla', councils: ['Sevilla', 'Dos Hermanas', 'Alcalá de Guadaíra', 'Utrera'] },
  { community: 'Andalucía', province: 'Málaga', councils: ['Málaga', 'Marbella', 'Vélez-Málaga', 'Mijas', 'Fuengirola'] },
  { community: 'Andalucía', province: 'Granada', councils: ['Granada', 'Motril', 'Almuñécar', 'Baza'] },
  { community: 'Comunidad Valenciana', province: 'Valencia', councils: ['Valencia', 'Gandía', 'Torrent', 'Paterna', 'Sagunto'] },
  { community: 'Comunidad Valenciana', province: 'Alicante', councils: ['Alicante', 'Elche', 'Torrevieja', 'Orihuela', 'Benidorm'] },
  { community: 'País Vasco', province: 'Vizcaya', councils: ['Bilbao', 'Barakaldo', 'Getxo', 'Portugalete'] },
  { community: 'País Vasco', province: 'Guipúzcoa', councils: ['San Sebastián', 'Irún', 'Rentería', 'Eibar'] },
  { community: 'Galicia', province: 'A Coruña', councils: ['A Coruña', 'Santiago de Compostela', 'Ferrol', 'Narón'] },
  { community: 'Galicia', province: 'Pontevedra', councils: ['Vigo', 'Pontevedra', 'Vilagarcía de Arousa'] },
  { community: 'Castilla y León', province: 'Valladolid', councils: ['Valladolid', 'Medina del Campo', 'Laguna de Duero'] },
  { community: 'Castilla y León', province: 'Burgos', councils: ['Burgos', 'Miranda de Ebro', 'Aranda de Duero'] },
  { community: 'Región de Murcia', province: 'Murcia', councils: ['Murcia', 'Cartagena', 'Lorca', 'Molina de Segura'] },
  { community: 'Islas Baleares', province: 'Baleares', councils: ['Palma', 'Calvià', 'Ibiza', 'Manacor', 'Mahón'] },
]

// Nombres españoles
const NOMBRES = ['María', 'Carmen', 'Ana', 'Laura', 'Isabel', 'Lucía', 'Elena', 'Marta', 'Sara', 'Paula',
  'Antonio', 'José', 'Manuel', 'Francisco', 'David', 'Juan', 'Carlos', 'Miguel', 'Pedro', 'Javier']
const APELLIDOS = ['García', 'Rodríguez', 'Martínez', 'López', 'González', 'Hernández', 'Pérez', 'Sánchez',
  'Ramírez', 'Torres', 'Flores', 'Rivera', 'Gómez', 'Díaz', 'Reyes', 'Morales', 'Cruz', 'Ortiz', 'Ruiz', 'Álvarez']

// Empresas de recolección
const EMPRESAS = ['EcoRecicla S.L.', 'VerdeClean S.A.', 'Reciclajes del Norte', 'GreenWaste Ibérica',
...
function generateCodigoPostal(province: string): string {
  const prefijos: Record<string, string> = {
    ...
    'Madrid': '28', 'Sevilla': '41', 'Málaga': '29', 'Granada': '18',
    'Valencia': '46', 'Alicante': '03', 'Vizcaya': '48', 'Guipúzcoa': '20',
    'A Coruña': '15', 'Pontevedra': '36', 'Valladolid': '47', 'Burgos': '09',
...
async function seedData() {
  ...
  try {
    ...
    const collectorData = [
      ...
      { name: 'María Recogida', email: 'maria@recolector.com', zone: 'Sur' },
      ...
      { name: 'Sara Ecológica', email: 'sara@recolector.com', zone: 'Centro' },
    ]
